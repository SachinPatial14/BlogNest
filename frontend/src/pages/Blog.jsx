  ...
  return data ? (
    <div className='relative'>
     ...
     <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
         ...
         <div className='rich-text max-w-3xl max-auto' dangerouslySetInnerHTML={{__html:data.description}}></div>
         {/* comment section */}
         <div className='mt-14 mb-10 max-w'>
         ...
         <div className='my-24 max-w-3xl mx-auto'>
          ...
          <div className='flex'>
            ...
            <img src={assets.googleplus_icon} width={50} alt="google-plus icon" />
          </div>
         </div>
     </div>
     <Footer />
